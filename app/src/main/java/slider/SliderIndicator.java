...
public class SliderIndicator implements ViewPager.OnPageChangeListener {
    ...
    public void setSize(@DimenRes int dimensRes) {
        mSize = dimensRes;
    }
    ...
    private void initIndicators() {
        ...
        for (int i = 0; i < mPageCount; i++) {
            ...
            int dimen = mSize != 0 ? resources.getDimensionPixelSize(mSpacing) : ((int) resources.getDisplayMetrics().density * defaultSizeInDp);
            int margin = mSpacing != 0 ? resources.getDimensionPixelSize(mSpacing) : ((int) resources.getDisplayMetrics().density * defaultSpacingInDp);
